...
namespace KTDapperDB
{
    public partial class KTDapperDBConnection : PostgrSQLConnection
    {
        ...
        public KTDapperDBConnection(string connectionString) : base(connectionString)
        {
        }
    }
}
